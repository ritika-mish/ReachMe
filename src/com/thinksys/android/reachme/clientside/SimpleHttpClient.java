...
import com.thinksys.android.reachme.ContactManager;
import com.thinksys.android.reachme.R;
 ...
 /** The time it takes for our client to timeout */
    ...
    private static SSLSocketFactory newSslSocketFactory() {
        try {
          ...
          InputStream in = ContactManager.getAppContext().getResources().openRawResource(R.raw.keystore);
          try {
